...
def generate_launch_description():
    ...
    # Spawn the Robot #
    declare_spawn_model_name = DeclareLaunchArgument("model_name", default_value="robot_2",
    ...
    declare_spawn_y = DeclareLaunchArgument("y", default_value="-0.6",
